...
open class Snapshot: NSObject {
    ...
    class func setLanguage(_ app: XCUIApplication) {
        ...
        } catch { NSLog("Couldn't detect/set language...") }
    }
    ...
    class func setLocale(_ app: XCUIApplication) {
        ...
        do {
            currentLocale = try String(contentsOf: path, encoding: .utf8).trimmingCharacters(in: .whitespacesAndNewlines)
        } catch { NSLog("Couldn't detect/set locale...") }
    ...
    class func setLaunchArguments(_ app: XCUIApplication) {
        ...
        } catch { NSLog("Couldn't detect/set launch_arguments...") }
    }
...
private extension XCUIElementQuery {
    ...
    var deviceStatusBars: XCUIElementQuery {
        guard let app = Snapshot.app else {
            fatalError("XCUIApplication is not set.")
        }
